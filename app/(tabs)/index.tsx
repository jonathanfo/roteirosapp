...
export default function App() {
  ...
  async function handleGenerate() {
    ...
    const prompt = `Crie um roteiro para uma viagem de exatos ${days.toFixed(0)} dias na cidade de ${city}, busque por lugares turisticos,com valores, lugares mais visitados, seja preciso nos dias de estadia fornecidos e limite o roteiro apenas na cidade fornecida. Forneça apenas em tópicos com nome do local onde ir em cada dia.`
...
.finally(() => {
  setLoading(false);
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.heading}>Roteiros Inteligente </Text>
